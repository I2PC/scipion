...
protected:
    ...
    void defineParams()
    {
        ...
        addUsageLine("data_block1");
        addUsageLine("_dimensions3D  'Xdim Ydim Zdim'");
        addUsageLine("_phantomBGDensity Background_Density");
        addUsageLine("_scale  Scale");
        addUsageLine("# Feature Parameters:");
        addUsageLine("# The feature density (Required)");
        addUsageLine("# The feature center (Required)");
        addUsageLine("data_block2");
        addUsageLine("_featureType");
        addUsageLine("_featureOperation");
        addUsageLine("_featureDensity");
        addUsageLine("_featureCenter");
        addUsageLine("_featureSpecificVector");
        addUsageLine("+An example of a metadata:");
        addUsageLine("+data_block1");
        addUsageLine("+_dimensions3D  '65 65 65'");
        addUsageLine("+_phantomBGDensity   0");
        addUsageLine("+_scale   1");
        addUsageLine("+data_block2");
        addUsageLine("+_featureType");
        addUsageLine("+_featureOperation");
        addUsageLine("+_featureDensity");
