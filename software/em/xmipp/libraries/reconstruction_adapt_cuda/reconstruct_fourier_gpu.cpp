...
void ProgRecFourierGPU::run()
{
    ...
    th_args = (ImageThreadParamsGPU *) malloc ( numThreads * sizeof( ImageThreadParamsGPU ) );
...
void * ProgRecFourierGPU::processImageThread( void * threadArgs )
{

    ImageThreadParamsGPU * threadParams = (ImageThreadParamsGPU *) threadArgs;
...
//#define DEBUG
void ProgRecFourierGPU::processImages( int firstImageIndex, int lastImageIndex, bool saveFSC, bool reprocessFlag)
{
...
void ProgRecFourierGPU::correctWeight()
{
...
void ProgRecFourierGPU::forceWeightSymmetry(MultidimArray<double> &FourierWeights)
{
