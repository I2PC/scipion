...
Messi.prototype = {
  ...
  options: {
    autoclose: null,                         // autoclose message after 'x'
												// miliseconds, i.e: 5000
    buttons: [],                             // array of buttons, i.e: [{id:
												// 'ok', label: 'OK', val:
												// 'OK'}]
    callback: null,                          // callback function after close
												// message
    center: true,                            // center message on screen
    closeButton: false,                       // show close button in header
												// title (or content if buttons
												// array is empty).
    height: 'auto',                          // content height
    title: null,                             // message title
    titleClass: null,                        // title style: info, warning,
												// success, error
    modal: false,                            // shows message in modal (loads
												// background)
