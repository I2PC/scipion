...
void ProgProject::defineParams()
{
    ...
    addExampleLine("+++http://sourceforge.net/p/testxmipp/code/ci/3.0/tree/input/phantomProject.param?format=raw",false);
    addExampleLine("+++",false);
    addExampleLine("+++http://sourceforge.net/p/testxmipp/code/ci/3.0/tree/input/uniformProjection_xmd.param?format=raw",false);
    addExampleLine("+++",false);
    addExampleLine("+++http://sourceforge.net/p/testxmipp/code/ci/3.0/tree/input/clusterProjection_xmd.param?format=raw",false);
    addExampleLine("+++",false);
    ...
    addExampleLine("+++In the following links you can find some examples of projection parameter files",false);
    addExampleLine("+++",false);
    addExampleLine("+++http://sourceforge.net/p/testxmipp/code/ci/3.0/tree/input/Crystal/MRCCrystalProj_xmd.param?format=raw",false);
    addExampleLine("+++",false);
    addExampleLine("+++ http://sourceforge.net/p/testxmipp/code/ci/3.0/tree/input/Crystal/cylinder_with_axis.descr?format=raw",false);
    addExampleLine("+++",false);
    addExampleLine("+++http://sourceforge.net/p/testxmipp/code/ci/3.0/tree/input/Crystal/MRC_crystal_projection_xmd.param?format=raw",false);
    addExampleLine("+++",false);
