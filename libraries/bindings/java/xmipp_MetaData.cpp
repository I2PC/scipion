...
(JNIEnv * env, jobject jobj, jstring joutput, jboolean independent, jboolean applyGeo, jint image_label)
{
    XMIPP_JAVA_TRY
    {
        MetaData * md = GET_INTERNAL_METADATA(jobj);
        ...
        copyImages(*md, output, independent, applyGeo, (MDLabel) image_label);
