...
main(int argc, char** argv)
{
    ...
    try
    {
        ...
        FuzzyCMeans thisFCmeans(m, eps, iter);  // Creates Fuzzy c-means Algorithm
        ...
        // Test algorithm
        Feature qerror = thisFCmeans.test(*thisFCB, ts);
        ...
        Feature F = thisFCmeans.F(*thisFCB);
        Feature H = thisFCmeans.H(*thisFCB);
        Feature NFI = thisFCmeans.NFI(*thisFCB);
        Feature S = thisFCmeans.S(*thisFCB, ts);
