...
#include <parallel/mpi_reconstruct_art.h>
...
RUN_XMIPP_PROGRAM(ProgMPIReconsArt)
...
//    if (rank == 0)
//    {
//        if (art_prm.parallel_mode == BasicARTParameters::pSART)
//        {
...
//        }
//        else if (art_prm.parallel_mode == BasicARTParameters::pCAV)
//            std::cout << "pCAV" << std::endl;
//        else if (art_prm.parallel_mode == BasicARTParameters::pBiCAV)
//        {
//            if (art_prm.block_size < size) art_prm.block_size = size;  // Each processor will have at least one projection
//            if (art_prm.block_size > num_img_tot) art_prm.block_size = num_img_tot;  // block_size is as much equal to num_img_tot
//            std::cout << "pBiCAV " << "TB = " << art_prm.block_size << std::endl;
//        }
//        else if (art_prm.parallel_mode == BasicARTParameters::pSIRT)
//            std::cout << "pSIRT" << std::endl;
//        else if (art_prm.parallel_mode == BasicARTParameters::pfSIRT)
...
//    if (art_prm.parallel_mode == BasicARTParameters::pCAV)
//    {
//
...
//            art_prm.numIMG = art_prm.block_size;
//
//            art_prm.parallel_mode = BasicARTParameters::pCAV; // Another trick
//
//            STARTINGX(art_prm.ordered_list) = -myFirst;
//
//            for (int ns = 0; ns < numsteps ; ns++)
...
//                }
//            }
//            art_prm.parallel_mode = BasicARTParameters::pBiCAV; // trick undone
//        }
//        else if (art_prm.parallel_mode == BasicARTParameters::pCAV)
//        {
//
...
//            STARTINGX(art_prm.ordered_list) = -myFirst;
//
//            if (art_prm.parallel_mode == BasicARTParameters::pSIRT ||
//                art_prm.parallel_mode == BasicARTParameters::pfSIRT)
//            {
//                for (int jj = 0 ; jj < vol_basis.VolumesNo() ; jj++)
//                    vol_aux2(jj)() = vol_basis(jj)();
//            }
...
//                comms_t_it += aux_t;
//
//                if (art_prm.parallel_mode == BasicARTParameters::pfSIRT)
//                {
...
//            if (art_prm.parallel_mode == BasicARTParameters::pBiCAV)
