...
void AutoParticlePicking::setNumThreads(int _numThreads)
{
...
void AutoParticlePicking::buildSelectionModel()
{
...
void AutoParticlePicking::buildVectors(std::vector<int> &_idx,
...
/* Save models ------------------------------------------------------------- */
void AutoParticlePicking::saveModels(const FileName &_fn_root)
{
    FileName fn_root=_fn_root;
    if (fn_root=="") fn_root=__modelRootName;
...
/* Configure auto ---------------------------------------------------------- */
void AutoParticlePicking::configure_auto(int _ellipse_radius)
{
