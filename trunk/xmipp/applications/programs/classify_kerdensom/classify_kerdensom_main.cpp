...
public:
    ...
    void defineParams()
    {
        ...
        addParamsLine(" [-o <file_out>]              : Output file");
        ...
        addParamsLine("                              :+   Xdim is ------>");
        addParamsLine("                              :+   HEXAGONAL:");
        addParamsLine("                              :+ O O O O O O O O O");
        addParamsLine("                              :+O O O & & & O O O");
        addParamsLine("                              :+ O O & @ @ & O O O");
        addParamsLine("                              :+O O & @ + @ & O O");
        addParamsLine("                              :+ O O & @ @ & O O O");
        addParamsLine("                              :+O O O & & & O O O");
        addParamsLine("                              :+ O O O O O O O O O");
        addParamsLine("                              :+   RECTANGULAR:");
        addParamsLine("                              :+O O O O O O O O O");
        addParamsLine("                              :+0 O O O & O O O O");
        addParamsLine("                              :+O O O & @ & O O O");
        addParamsLine("                              :+O O & @ + @ & O O");
        addParamsLine("                              :+O O O & @ & O O O");
        addParamsLine("                              :+O O O O & O O O O");
        addParamsLine("                              :+O O O O O O O O O");
        addParamsLine("                              :+</verbatim>");
