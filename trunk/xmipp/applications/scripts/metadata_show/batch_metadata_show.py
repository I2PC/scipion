...
class ScriptMetadataShow(XmippScript):
    ...
    def defineParams(self):
        self.addUsageLine("Display metadata columns with a Multilistbox.")
        ## params
        self.addParamsLine(" -i <metadata>          : Keyword list to search programs matching")
