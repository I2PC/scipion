 ...
 */
class TStudentKerDenSOM : public KerDenSOM
{
public:
     ...
     */
    TStudentKerDenSOM(double _reg0, double _reg1, unsigned long _annSteps,
                           double _epsilon, unsigned long _nSteps, int _df = 3)
            : KerDenSOM(_reg0, _reg1, _annSteps, _epsilon, _nSteps), df(_df)
    {};

    /**
     * Virtual destructor
     */
    virtual ~TStudentKerDenSOM()
    {};
...
protected:
    ...
    // Remake U (Membership)
    void reMakeU(FuzzyMap* _som, const TS* _examples, const double& _sigma);
