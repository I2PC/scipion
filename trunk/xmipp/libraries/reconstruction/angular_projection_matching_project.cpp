...
//UNTESTED CODE
void
Prog_Angular_Projection_Matching_Project_Parameters::createDocFileWithExperimentalImages(void)
{   
    SelFile         mySF
    DocFile         myDF;
...
void
Prog_Angular_Projection_Matching_Project_Parameters::remove_points_not_close_to_experimental_points(void)
{   
