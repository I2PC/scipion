...
Prog_PDBPhantom_Parameters::Prog_PDBPhantom_Parameters() {
   ...
   periodic_table(0,0)=0.53; periodic_table(0,1)=1;  // Hydrogen
   periodic_table(1,0)=0.67; periodic_table(1,1)=12; // Carbon
   periodic_table(2,0)=0.56; periodic_table(2,1)=14; // Nitrogen
   periodic_table(3,0)=0.48; periodic_table(3,1)=16; // Oxygen
