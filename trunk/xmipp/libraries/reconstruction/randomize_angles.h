...
#ifndef _RANDOMIZE_ANGLES_HH
#define _RANDOMIZE_ANGLES_HH
...
public:
    ...
    void processAngles();
    /** Create auxiliary symmetry matrices   */
    void symmetryInicialization();
public:
    /** Filenames */
    FileName fn_sel, fn_doc, fh_out, fn_sym;
