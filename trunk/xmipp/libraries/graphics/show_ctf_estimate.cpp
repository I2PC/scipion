...
AssignCTFViewer::AssignCTFViewer(const FileName &_fn_psd,
   ...
   // Set min_freq
   min.push_back(0); max.push_back(50); prm_name.push_back("Minimum freq. (x100)");
   initial_value.push_back(assign_ctf_prm.adjust_CTF_prm.min_freq*100);
   // Set max_freq
   min.push_back(0); max.push_back(50); prm_name.push_back("Maximum freq. (x100)");
   initial_value.push_back(assign_ctf_prm.adjust_CTF_prm.max_freq*100);
   // Set DefocusU
   min.push_back(-100); max.push_back(-1); prm_name.push_back("DefocusU (/1000)");
   initial_value.push_back(
      assign_ctf_prm.adjust_CTF_prm.initial_ctfmodel.DeltafU/1000);
   // Set DefocusV
   min.push_back(-100); max.push_back(-1); prm_name.push_back("DefocusV (/1000)");
   initial_value.push_back(
      assign_ctf_prm.adjust_CTF_prm.initial_ctfmodel.DeltafV/1000);
   // Set Angle
   min.push_back(0); max.push_back(360); prm_name.push_back("Angle");
   initial_value.push_back(
...
void AssignCTFViewer::updateMask(vector<float> &prm) {
   ...
   double r2_min=min_freq*XSIZE(xmippImage_backup); r2_min*=r2_min;
   double r2_max=max_freq*XSIZE(xmippImage_backup); r2_max*=r2_max;
