...
public class MDLabel {
   ...
   public static final int MDL_PICKING_FAMILY = 135;  ///< Family for particle picking
   public static final int MDL_PICKING_COLOR = 136;  ///< Color for particle picking
   public static final int MDL_PICKING_PARTICLE_SIZE = 137;  ///< Particle size for particle picking
   public static final int MDL_PMAX = 138;  ///< Maximum value of normalized probability function (now called "Pmax/sumP") (double)
   public static final int MDL_PRJ_DIMENSIONS = 139;  // X = 139; Y dimensions for the generated projections
   public static final int MDL_PRJ_TILT_RANGE = 140;  // Vector with the initial and final tilt angle values = 140;  and step size
   public static final int MDL_PRJ_VOL = 141;         // Volume file name to generate projections from
   public static final int MDL_PSD = 142;  ///< A Power Spectrum Density file name (std::string)
   public static final int MDL_PSD_ENHANCED = 143;  ///< A enhanced Power Spectrum Density file name (std::string)
   public static final int MDL_RANDOMSEED = 144;  ///< Seed for random number generator
   public static final int MDL_REF3D = 145;  ///< 3D Class to which the image belongs (int)
   public static final int MDL_REF = 146;  ///< Class to which the image belongs (int)
   public static final int MDL_REFMD = 147;  ///< Name of Metadata file for all references(string)
   public static final int MDL_RESOLUTION_DPR = 148;  ///<differential phase residual (double)
   public static final int MDL_RESOLUTION_ERRORL2 = 149;  ///<Error in l2 (double)
   public static final int MDL_RESOLUTION_FRC = 150;  ///<Fourier shell correlation (double)
   public static final int MDL_RESOLUTION_FRCRANDOMNOISE = 151;  ///<Fourier shell correlation noise (double)
   public static final int MDL_RESOLUTION_FREQ = 152;  ///<Frequency in 1/A (double)
   public static final int MDL_RESOLUTION_FREQREAL = 153;  ///< Frequency in A (double)
   public static final int MDL_SAMPLINGRATE = 154;  ///< sampling rate in A/pixel (double)
   public static final int MDL_SAMPLINGRATEX = 155;  ///< sampling rate in A/pixel (double)
   public static final int MDL_SAMPLINGRATEY = 156;  ///< sampling rate in A/pixel (double)
   public static final int MDL_SAMPLINGRATEZ = 157;  ///< sampling rate in A/pixel (double)
   public static final int MDL_SCALE = 158;  ///< scaling factor for an image or volume (double)
   public static final int MDL_SELFILE = 159;  ///< Name of an image (std::string)
   public static final int MDL_SERIE = 160;  ///< A collection of micrographs = 160;  e.g. a tilt serie (std::string)
   public static final int MDL_SHIFTX = 161;  ///< Shift for the image in the X axis (double)
   public static final int MDL_SHIFTY = 162;  ///< Shift for the image in the Y axis (double)
   public static final int MDL_SHIFTZ = 163;  ///< Shift for the image in the Z axis (double)
   public static final int MDL_SHIFT_CRYSTALX = 164;  ///< Shift for the image in the X axis (double) for crystals
   public static final int MDL_SHIFT_CRYSTALY = 165;  ///< Shift for the image in the Y axis (double) for crystals
   public static final int MDL_SHIFT_CRYSTALZ = 166;  ///< Shift for the image in the Z axis (double) for crystals
   public static final int MDL_SIGMANOISE = 167;  ///< Standard deviation of the noise in ML model
   public static final int MDL_SIGMAOFFSET = 168;  ///< Standard deviation of the offsets in ML model
   public static final int MDL_SIGNALCHANGE = 169;  ///< Signal change for an image
   public static final int MDL_SPHERICALABERRATION = 170;  ///<ctf definition azimutal angle
   public static final int MDL_STDDEV = 171;  ///<stdandard deviation value (double)
   public static final int MDL_SUM = 172;  ///< Sum of elements of a given type (double) [this is a genereic type do not use to transfer information to another program]
   public static final int MDL_SUMWEIGHT = 173;  ///< Sum of all weights in ML model
   public static final int MDL_SYMNO = 174;  ///< Symmetry number for a projection (used in ART)
   public static final int MDL_TRANSFORMATIONMTRIX = 175;  ///< transformation matrix(vector double)
   public static final int MDL_VOLTAGE = 176;  ///< microscope voltage (double)
   public static final int MDL_WEIGHT = 177;  ///< Weight assigned to the image (double)
   public static final int MDL_WROBUST = 178;  ///< Weight of t-student distribution in robust Maximum likelihood
   public static final int MDL_X = 179;  ///< X component (double)
   public static final int MDL_XINT = 180;  ///< X component (int)
   public static final int MDL_XINTTILT = 181;  ///< X component in tilted micrograph (int)
   public static final int MDL_XSIZE = 182;  ///< X size (int)
   public static final int MDL_Y = 183;  ///< Y component (double)
   public static final int MDL_YINT = 184;  ///< Y component (int)
   public static final int MDL_YINTTILT = 185;  ///< Y component in tilted micrograph (int)
   public static final int MDL_YSIZE = 186;  ///< Y size (int)
   public static final int MDL_Z = 187;  ///< Z component (double)
   public static final int MDL_ZINT = 188;  ///< Z component (int)
   public static final int MDL_ZSCORE = 189;  ///< Z Score (double)
   public static final int MDL_ZSIZE = 190;  ///< Z size (int)
   public static final int MDL_LAST_LABEL = 191;  // **** NOTE ****: Do keep this label always at the end;it is here for looping purposes
}
