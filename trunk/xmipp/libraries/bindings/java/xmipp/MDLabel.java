...
public class MDLabel {
   ...
   public static final int MDL_IDX = 93;  ///< Index within a list (size_t)
   ...
   public static final int MDL_NEIGHBORHOOD_RADIUS = 125;  ///< Radius of the neigborhood (radians)
   public static final int MDL_NMA = 126;  ///< Normal mode displacements (vector double)
   public static final int MDL_NMA_MODEFILE = 127;  ///< File with an NMA mode
   public static final int MDL_NOISE_ANGLES = 128;  ///< Noise description for projected angles
   public static final int MDL_NOISE_PARTICLE_COORD = 129;  ///< Noise description for particle's center coordenates (when projecting)
   public static final int MDL_NOISE_PIXEL_LEVEL = 130;  ///< Noise description for pixels' gray level (when projecting)
   public static final int MDL_ORDER = 131;  /// auxiliary label to be used as an index (long)
   public static final int MDL_ORIGINX = 132;  ///< Origin for the image in the X axis (double)
   public static final int MDL_ORIGINY = 133;  ///< Origin for the image in the Y axis (double)
   public static final int MDL_ORIGINZ = 134;  ///< Origin for the image in the Z axis (double)
   public static final int MDL_PICKING_COLOR = 135;  ///< Color for particle picking
   public static final int MDL_PICKING_FAMILY = 136;  ///< Family for particle picking
   public static final int MDL_PICKING_FAMILY_STATE = 137;  ///< Family state for particle picking
   public static final int MDL_PICKING_MICROGRAPH_FAMILY_STATE = 138;  ///< Micrograph family state for particle picking
   public static final int MDL_PICKING_PARTICLE_SIZE = 139;  ///< Particle size for particle picking
   public static final int MDL_PMAX = 140;  ///< Maximum value of normalized probability function (now called "Pmax/sumP") (double)
   public static final int MDL_PRJ_DIMENSIONS = 141;  // X = 141; Y dimensions for the generated projections
   public static final int MDL_PRJ_TILT_RANGE = 142;  // Vector with the initial and final tilt angle values = 142;  and step size
   public static final int MDL_PRJ_VOL = 143;         // Volume file name to generate projections from
   public static final int MDL_PSD = 144;  ///< A Power Spectrum Density file name (std::string)
   public static final int MDL_PSD_ENHANCED = 145;  ///< A enhanced Power Spectrum Density file name (std::string)
   public static final int MDL_RANDOMSEED = 146;  ///< Seed for random number generator
   public static final int MDL_REF3D = 147;  ///< 3D Class to which the image belongs (int)
   public static final int MDL_REF = 148;  ///< Class to which the image belongs (int)
   public static final int MDL_REFMD = 149;  ///< Name of Metadata file for all references(string)
   public static final int MDL_RESOLUTION_DPR = 150;  ///<differential phase residual (double)
   public static final int MDL_RESOLUTION_ERRORL2 = 151;  ///<Error in l2 (double)
   public static final int MDL_RESOLUTION_FRC = 152;  ///<Fourier shell correlation (double)
   public static final int MDL_RESOLUTION_FRCRANDOMNOISE = 153;  ///<Fourier shell correlation noise (double)
   public static final int MDL_RESOLUTION_FREQ = 154;  ///<Frequency in 1/A (double)
   public static final int MDL_RESOLUTION_FREQREAL = 155;  ///< Frequency in A (double)
   public static final int MDL_SAMPLINGRATE = 156;  ///< sampling rate in A/pixel (double)
   public static final int MDL_SAMPLINGRATEX = 157;  ///< sampling rate in A/pixel (double)
   public static final int MDL_SAMPLINGRATEY = 158;  ///< sampling rate in A/pixel (double)
   public static final int MDL_SAMPLINGRATEZ = 159;  ///< sampling rate in A/pixel (double)
   public static final int MDL_SCALE = 160;  ///< scaling factor for an image or volume (double)
   public static final int MDL_SELFILE = 161;  ///< Name of an image (std::string)
   public static final int MDL_SERIE = 162;  ///< A collection of micrographs = 162;  e.g. a tilt serie (std::string)
   public static final int MDL_SHIFTX = 163;  ///< Shift for the image in the X axis (double)
   public static final int MDL_SHIFTY = 164;  ///< Shift for the image in the Y axis (double)
   public static final int MDL_SHIFTZ = 165;  ///< Shift for the image in the Z axis (double)
   public static final int MDL_SHIFT_CRYSTALX = 166;  ///< Shift for the image in the X axis (double) for crystals
   public static final int MDL_SHIFT_CRYSTALY = 167;  ///< Shift for the image in the Y axis (double) for crystals
   public static final int MDL_SHIFT_CRYSTALZ = 168;  ///< Shift for the image in the Z axis (double) for crystals
   public static final int MDL_SIGMANOISE = 169;  ///< Standard deviation of the noise in ML model
   public static final int MDL_SIGMAOFFSET = 170;  ///< Standard deviation of the offsets in ML model
   public static final int MDL_SIGNALCHANGE = 171;  ///< Signal change for an image
   public static final int MDL_SPHERICALABERRATION = 172;  ///<ctf definition azimutal angle
   public static final int MDL_STDDEV = 173;  ///<stdandard deviation value (double)
   public static final int MDL_SUM = 174;  ///< Sum of elements of a given type (double) [this is a genereic type do not use to transfer information to another program]
   public static final int MDL_SUMWEIGHT = 175;  ///< Sum of all weights in ML model
   public static final int MDL_SYMNO = 176;  ///< Symmetry number for a projection (used in ART)
   public static final int MDL_TRANSFORMATIONMTRIX = 177;  ///< transformation matrix(vector double)
   public static final int MDL_VOLTAGE = 178;  ///< microscope voltage (double)
   public static final int MDL_WEIGHT = 179;  ///< Weight assigned to the image (double)
   public static final int MDL_WROBUST = 180;  ///< Weight of t-student distribution in robust Maximum likelihood
   public static final int MDL_X = 181;  ///< X component (double)
   public static final int MDL_XINT = 182;  ///< X component (int)
   public static final int MDL_XINTTILT = 183;  ///< X component in tilted micrograph (int)
   public static final int MDL_XSIZE = 184;  ///< X size (int)
   public static final int MDL_Y = 185;  ///< Y component (double)
   public static final int MDL_YINT = 186;  ///< Y component (int)
   public static final int MDL_YINTTILT = 187;  ///< Y component in tilted micrograph (int)
   public static final int MDL_YSIZE = 188;  ///< Y size (int)
   public static final int MDL_Z = 189;  ///< Z component (double)
   public static final int MDL_ZINT = 190;  ///< Z component (int)
   public static final int MDL_ZSCORE = 191;  ///< Z Score (double)
   public static final int MDL_ZSIZE = 192;  ///< Z size (int)
   public static final int MDL_LAST_LABEL = 193;  // **** NOTE ****: Do keep this label always at the end;it is here for looping purposes
}
