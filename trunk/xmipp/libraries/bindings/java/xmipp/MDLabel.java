...
public class MDLabel {
   ...
   public static final int MDL_NOISE_ANGLES = 125;  ///< Noise description for projected angles
   public static final int MDL_NOISE_PARTICLE_COORD = 126;  ///< Noise description for particle's center coordenates (when projecting)
   public static final int MDL_NOISE_PIXEL_LEVEL = 127;  ///< Noise description for pixels' gray level (when projecting)
   public static final int MDL_ORDER = 128;  /// auxiliary label to be used as an index (long)
   public static final int MDL_ORIGINX = 129;  ///< Origin for the image in the X axis (double)
   public static final int MDL_ORIGINY = 130;  ///< Origin for the image in the Y axis (double)
   public static final int MDL_ORIGINZ = 131;  ///< Origin for the image in the Z axis (double)
   public static final int MDL_PMAX = 132;  ///< Maximum value of normalized probability function (now called "Pmax/sumP") (double)
   public static final int MDL_PRJ_DIMENSIONS = 133;  // X = 133; Y dimensions for the generated projections
   public static final int MDL_PRJ_TILT_RANGE = 134;  // Vector with the initial and final tilt angle values = 134;  and step size
   public static final int MDL_PRJ_VOL = 135;         // Volume file name to generate projections from
   public static final int MDL_PSD = 136;  ///< A Power Spectrum Density file name (std::string)
   public static final int MDL_RANDOMSEED = 137;  ///< Seed for random number generator
   public static final int MDL_REF3D = 138;  ///< 3D Class to which the image belongs (int)
   public static final int MDL_REF = 139;  ///< Class to which the image belongs (int)
   public static final int MDL_REFMD = 140;  ///< Name of Metadata file for all references(string)
   public static final int MDL_RESOLUTION_DPR = 141;  ///<differential phase residual (double)
   public static final int MDL_RESOLUTION_ERRORL2 = 142;  ///<Error in l2 (double)
   public static final int MDL_RESOLUTION_FRC = 143;  ///<Fourier shell correlation (double)
   public static final int MDL_RESOLUTION_FRCRANDOMNOISE = 144;  ///<Fourier shell correlation noise (double)
   public static final int MDL_RESOLUTION_FREQ = 145;  ///<Frequency in 1/A (double)
   public static final int MDL_RESOLUTION_FREQREAL = 146;  ///< Frequency in A (double)
   public static final int MDL_SAMPLINGRATE = 147;  ///< sampling rate in A/pixel (double)
   public static final int MDL_SAMPLINGRATEX = 148;  ///< sampling rate in A/pixel (double)
   public static final int MDL_SAMPLINGRATEY = 149;  ///< sampling rate in A/pixel (double)
   public static final int MDL_SAMPLINGRATEZ = 150;  ///< sampling rate in A/pixel (double)
   public static final int MDL_SCALE = 151;  ///< scaling factor for an image or volume (double)
   public static final int MDL_SELFILE = 152;  ///< Name of an image (std::string)
   public static final int MDL_SERIE = 153;  ///< A collection of micrographs = 153;  e.g. a tilt serie (std::string)
   public static final int MDL_SHIFTX = 154;  ///< Shift for the image in the X axis (double)
   public static final int MDL_SHIFTY = 155;  ///< Shift for the image in the Y axis (double)
   public static final int MDL_SHIFTZ = 156;  ///< Shift for the image in the Z axis (double)
   public static final int MDL_SHIFT_CRYSTALX = 157;  ///< Shift for the image in the X axis (double) for crystals
   public static final int MDL_SHIFT_CRYSTALY = 158;  ///< Shift for the image in the Y axis (double) for crystals
   public static final int MDL_SHIFT_CRYSTALZ = 159;  ///< Shift for the image in the Z axis (double) for crystals
   public static final int MDL_SIGMANOISE = 160;  ///< Standard deviation of the noise in ML model
   public static final int MDL_SIGMAOFFSET = 161;  ///< Standard deviation of the offsets in ML model
   public static final int MDL_SIGNALCHANGE = 162;  ///< Signal change for an image
   public static final int MDL_SPHERICALABERRATION = 163;  ///<ctf definition azimutal angle
   public static final int MDL_STDDEV = 164;  ///<stdandard deviation value (double)
   public static final int MDL_SUM = 165;  ///< Sum of elements of a given type (double) [this is a genereic type do not use to transfer information to another program]
   public static final int MDL_SUMWEIGHT = 166;  ///< Sum of all weights in ML model
   public static final int MDL_SYMNO = 167;  ///< Symmetry number for a projection (used in ART)
   public static final int MDL_TRANSFORMATIONMTRIX = 168;  ///< transformation matrix(vector double)
   public static final int MDL_VOLTAGE = 169;  ///< microscope voltage (double)
   public static final int MDL_WEIGHT = 170;  ///< Weight assigned to the image (double)
   public static final int MDL_WROBUST = 171;  ///< Weight of t-student distribution in robust Maximum likelihood
   public static final int MDL_X = 172;  ///< X component (double)
   public static final int MDL_XINT = 173;  ///< X component (int)
   public static final int MDL_XINTTILT = 174;  ///< X component in tilted micrograph (int)
   public static final int MDL_XSIZE = 175;  ///< X size (int)
   public static final int MDL_Y = 176;  ///< Y component (double)
   public static final int MDL_YINT = 177;  ///< Y component (int)
   public static final int MDL_YINTTILT = 178;  ///< Y component in tilted micrograph (int)
   public static final int MDL_YSIZE = 179;  ///< Y size (int)
   public static final int MDL_Z = 180;  ///< Z component (double)
   public static final int MDL_ZINT = 181;  ///< Z component (int)
   public static final int MDL_ZSCORE = 182;  ///< Z Score (double)
   public static final int MDL_ZSIZE = 183;  ///< Z size (int)
   public static final int MDL_LAST_LABEL = 184;                       // **** NOTE ****: Do keep this label always at the end
}
