...
public class MDLabel {
   ...
   public static final int MDL_PMAX = 135;  ///< Maximum value of normalized probability function (now called "Pmax/sumP") (double)
   public static final int MDL_PRJ_DIMENSIONS = 136;  // X = 136; Y dimensions for the generated projections
   public static final int MDL_PRJ_TILT_RANGE = 137;  // Vector with the initial and final tilt angle values = 137;  and step size
   public static final int MDL_PRJ_VOL = 138;         // Volume file name to generate projections from
   public static final int MDL_PSD = 139;  ///< A Power Spectrum Density file name (std::string)
   public static final int MDL_PSD_ENHANCED = 140;  ///< A enhanced Power Spectrum Density file name (std::string)
   public static final int MDL_RANDOMSEED = 141;  ///< Seed for random number generator
   public static final int MDL_REF3D = 142;  ///< 3D Class to which the image belongs (int)
   public static final int MDL_REF = 143;  ///< Class to which the image belongs (int)
   public static final int MDL_REFMD = 144;  ///< Name of Metadata file for all references(string)
   public static final int MDL_RESOLUTION_DPR = 145;  ///<differential phase residual (double)
   public static final int MDL_RESOLUTION_ERRORL2 = 146;  ///<Error in l2 (double)
   public static final int MDL_RESOLUTION_FRC = 147;  ///<Fourier shell correlation (double)
   public static final int MDL_RESOLUTION_FRCRANDOMNOISE = 148;  ///<Fourier shell correlation noise (double)
   public static final int MDL_RESOLUTION_FREQ = 149;  ///<Frequency in 1/A (double)
   public static final int MDL_RESOLUTION_FREQREAL = 150;  ///< Frequency in A (double)
   public static final int MDL_SAMPLINGRATE = 151;  ///< sampling rate in A/pixel (double)
   public static final int MDL_SAMPLINGRATEX = 152;  ///< sampling rate in A/pixel (double)
   public static final int MDL_SAMPLINGRATEY = 153;  ///< sampling rate in A/pixel (double)
   public static final int MDL_SAMPLINGRATEZ = 154;  ///< sampling rate in A/pixel (double)
   public static final int MDL_SCALE = 155;  ///< scaling factor for an image or volume (double)
   public static final int MDL_SELFILE = 156;  ///< Name of an image (std::string)
   public static final int MDL_SERIE = 157;  ///< A collection of micrographs = 157;  e.g. a tilt serie (std::string)
   public static final int MDL_SHIFTX = 158;  ///< Shift for the image in the X axis (double)
   public static final int MDL_SHIFTY = 159;  ///< Shift for the image in the Y axis (double)
   public static final int MDL_SHIFTZ = 160;  ///< Shift for the image in the Z axis (double)
   public static final int MDL_SHIFT_CRYSTALX = 161;  ///< Shift for the image in the X axis (double) for crystals
   public static final int MDL_SHIFT_CRYSTALY = 162;  ///< Shift for the image in the Y axis (double) for crystals
   public static final int MDL_SHIFT_CRYSTALZ = 163;  ///< Shift for the image in the Z axis (double) for crystals
   public static final int MDL_SIGMANOISE = 164;  ///< Standard deviation of the noise in ML model
   public static final int MDL_SIGMAOFFSET = 165;  ///< Standard deviation of the offsets in ML model
   public static final int MDL_SIGNALCHANGE = 166;  ///< Signal change for an image
   public static final int MDL_SPHERICALABERRATION = 167;  ///<ctf definition azimutal angle
   public static final int MDL_STDDEV = 168;  ///<stdandard deviation value (double)
   public static final int MDL_SUM = 169;  ///< Sum of elements of a given type (double) [this is a genereic type do not use to transfer information to another program]
   public static final int MDL_SUMWEIGHT = 170;  ///< Sum of all weights in ML model
   public static final int MDL_SYMNO = 171;  ///< Symmetry number for a projection (used in ART)
   public static final int MDL_TRANSFORMATIONMTRIX = 172;  ///< transformation matrix(vector double)
   public static final int MDL_VOLTAGE = 173;  ///< microscope voltage (double)
   public static final int MDL_WEIGHT = 174;  ///< Weight assigned to the image (double)
   public static final int MDL_WROBUST = 175;  ///< Weight of t-student distribution in robust Maximum likelihood
   public static final int MDL_X = 176;  ///< X component (double)
   public static final int MDL_XINT = 177;  ///< X component (int)
   public static final int MDL_XINTTILT = 178;  ///< X component in tilted micrograph (int)
   public static final int MDL_XSIZE = 179;  ///< X size (int)
   public static final int MDL_Y = 180;  ///< Y component (double)
   public static final int MDL_YINT = 181;  ///< Y component (int)
   public static final int MDL_YINTTILT = 182;  ///< Y component in tilted micrograph (int)
   public static final int MDL_YSIZE = 183;  ///< Y size (int)
   public static final int MDL_Z = 184;  ///< Z component (double)
   public static final int MDL_ZINT = 185;  ///< Z component (int)
   public static final int MDL_ZSCORE = 186;  ///< Z Score (double)
   public static final int MDL_ZSIZE = 187;  ///< Z size (int)
   public static final int MDL_LAST_LABEL = 188;  // **** NOTE ****: Do keep this label always at the end;it is here for looping purposes
}
