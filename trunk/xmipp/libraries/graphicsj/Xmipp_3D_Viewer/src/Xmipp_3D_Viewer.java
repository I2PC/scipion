 ...
 * @author Juanjo Vega
 */
public class Xmipp_3D_Viewer implements PlugIn, UniverseListener, iAnalyzer {
...
//            loc = windowSphere.getLocation();
    ...
    private void showScoreFile(String scoreFile) {
