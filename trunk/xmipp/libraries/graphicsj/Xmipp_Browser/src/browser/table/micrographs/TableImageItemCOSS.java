...
public class TableImageItemCOSS {
    ...
    protected TableModelMicrographs imagesTableModel;
    protected int slice = FileOpener.MID_SLICE;

    public TableImageItemCOSS(String parentDir, String fileName, Cache cache, TableModelMicrographs imagesTableModel) {
        this(parentDir, fileName, cache, FileOpener.MID_SLICE, imagesTableModel);
    }

    public TableImageItemCOSS(String parentDir, String fileName, Cache cache, int slice, TableModelMicrographs imagesTableModel) {
...
//    }
    ...
    public static ImagePlus readImage(String path) {
        ...
        ImageDouble image = new ImageDouble();//XmippData.readFullImage(path);
        image.read(fn);
