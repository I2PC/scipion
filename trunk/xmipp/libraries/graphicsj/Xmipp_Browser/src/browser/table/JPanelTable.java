...
public class JPanelTable extends javax.swing.JPanel {
    ...
    protected void normalize() {
        ...
        if (items.size() > 0) {
            ...
            ImageTableOperations.normalize(items);
    ...
    protected Dimension getCellSize() {
        ...
        TableImageItem item0 = (TableImageItem) tableModel.getValueAt(0, 0);

        int w = item0 != null ? item0.getThumbnailWidth() : 0;
        int h = item0 != null ? item0.getThumbnailHeight() + font_height : 0;
