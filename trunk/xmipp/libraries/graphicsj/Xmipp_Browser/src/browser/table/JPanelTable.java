...
public class JPanelTable extends javax.swing.JPanel {
    ...
    protected final static int CACHE_MAX_SIZE = 209715200;    // 1MB = 1024 KB => 200MB * 1024^2
    ...
    public JPanelTable() {
        ...
        jmiEnable.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_E, KeyEvent.VK_CONTROL));
        jmiDisable.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_D, KeyEvent.VK_CONTROL));
    ...
    public void refreshCacheSize() {
        if (isShowing()) {
            ...
            double siCell = cellSize.width * cellSize.height * 4;
            double cacheSize = CACHE_MAX_SIZE / siCell;
            System.out.println("Tamaño de una celda: " + siCell + " Bytes");
            System.out.println("cacheSize: " + cacheSize + " Bytes");

            //tableModel.setCacheSize(horizontal * vertical * 2);
            tableModel.resizeCache((int) (cacheSize * 2));
        }
    }
