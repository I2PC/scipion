...
public class JPanelTable extends javax.swing.JPanel {
    ...
    protected ImageRenderer tableRenderer;
    ...
    public JPanelTable() {
        ...
        tableRenderer = new ImageRenderer();
    ...
    private void openSelection() {
        ...
        for (int i = 0; i < rows.length; i++) {
            TableImageItem item = (TableImageItem) jtImages.getValueAt(rows[i], cols[i]);

            if (item != null) {
                ImagesWindowFactory.openImage(item);
            }
        }
    }
    ...
    public void addImageItem(XmippImageItem itemImage, int n) {
        tableModel.addImageItem(itemImage, n);
    }
...
//    }
//
//    public void addSelFile(SelFileItem selItem) {
//        tableModel.addSelFile(selItem);
//    }
