...
public class JFrameNormalization extends JFrame implements iNormalizeListener {
    ...
    public static void main(String args[]) {
        ...
        // Gets histograms
        int H[] = new int[256]; // Total histogram.
        ...
        short[] pixels = new short[H.length];
        ...
        histogram_.setProcessor("Histogram", processor);
        histogram_.setDisplayRange(0, 255);
        histogram_.show();

        HistogramWindow hw = new HistogramWindow(histogram_);
        hw.setVisible(true);
    }

    private static void addHistogram(int H[], int histogram[]) {
        for (int i = 0; i < H.length; i++) {
            H[i] = histogram[i];
        }
    }
