...
public class DM3_Reader extends ImagePlus implements PlugIn {
    ...
    public void run(String arg) {
        ...
        if ((arg == null) || (arg == "")) {	// Choose a file since none specified
    ...
    public ImagePlus loadThumbnail(String directory, String fileName, int w, int h, int slice) {
        ...
        try {
            ...
            IJ.showStatus("DM3: loadThumnbail() error");
            IJ.showMessage("DM3_Reader", "" + e);
            return null;
        }
    ...
    public void parseDM3(String directory, String fileName) throws IOException {
    ...
    public FileInfo getDM3FileInfo(String directory, String fileName) throws IOException {
    ...
    short blreadUShort() throws IOException // Identical to blreadShort - is this correct?
    ...
    long blreadLong() throws IOException // New fn, not quite sure if the little endian version is correct
    ...
    double blreadDouble() throws IOException // new fn to read 8 byte doubles using blreadLong as a base
    {
        if (!littleEndian) {
            return f.readDouble();
        }
    ...
    String readString(int n) throws IOException {
        ...
        if (n > 2000) {
            throw new IOException("Can't handle strings longer than 2000 chars, n = " + n + " at pos = " + f.getFilePointer());
        }
