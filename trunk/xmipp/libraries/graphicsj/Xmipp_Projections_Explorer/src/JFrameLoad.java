...
public class JFrameLoad extends JDialog {
    ...
    public String getEulerAnglesFile() {
        return jtfEulerAngles.getText();
    }

    private void enableLoadButton() {
        if (!jtfVolume.getText().isEmpty()
                && !jtfEulerAngles.getText().isEmpty()) {
    ...
    private void initComponents() {
        ...
        jpAngles = new javax.swing.JPanel();
        ...
        jpAngles.setBorder(javax.swing.BorderFactory.createTitledBorder(LABELS.LABEL_ANGLES));

        jtfEulerAngles.setColumns(20);
        jtfEulerAngles.setEnabled(false);
        jpAngles.add(jtfEulerAngles);
        ...
        jpAngles.add(jbAngles);

        jpControls.add(jpAngles);
    ...
    private javax.swing.JPanel jpAngles;
