...
xmippFREAD = _XmippData.xmippFREAD
xmippFWRITE = _XmippData.xmippFWRITE
...
class MetaData(_object):
    ...
    def containsLabel(*args): return _XmippData.MetaData_containsLabel(*args)
    def addLabel(*args): return _XmippData.MetaData_addLabel(*args)
    def addObject(*args): return _XmippData.MetaData_addObject(*args)
    def importObject(*args): return _XmippData.MetaData_importObject(*args)
    ...
    def addIndex(*args): return _XmippData.MetaData_addIndex(*args)
    def removeIndex(*args): return _XmippData.MetaData_removeIndex(*args)
    ...
    def previousObject(*args): return _XmippData.MetaData_previousObject(*args)
    def goToObject(*args): return _XmippData.MetaData_goToObject(*args)
    def iteratorBegin(*args): return _XmippData.MetaData_iteratorBegin(*args)
    def iteratorEnd(*args): return _XmippData.MetaData_iteratorEnd(*args)
    def iteratorNext(*args): return _XmippData.MetaData_iteratorNext(*args)
    ...
    def split(*args): return _XmippData.MetaData_split(*args)
    def selectSplitPart(*args): return _XmippData.MetaData_selectSplitPart(*args)
    def selectPart(*args): return _XmippData.MetaData_selectPart(*args)
...
MDL_MISSINGREGION_THY0 = _XmippData.MDL_MISSINGREGION_THY0
MDL_MISSINGREGION_THYF = _XmippData.MDL_MISSINGREGION_THYF
MDL_MISSINGREGION_THX0 = _XmippData.MDL_MISSINGREGION_THX0
MDL_MISSINGREGION_THXF = _XmippData.MDL_MISSINGREGION_THXF
...
MDL_SELFILE = _XmippData.MDL_SELFILE
...
MDL_ZSCORE = _XmippData.MDL_ZSCORE
...
LABEL_LONG = _XmippData.LABEL_LONG
class MDL(_object):
    __swig_setmethods__ = {}
    ...
    __swig_getmethods__["label2SqlColumn"] = lambda x: _XmippData.MDL_label2SqlColumn
    if _newclass:label2SqlColumn = staticmethod(_XmippData.MDL_label2SqlColumn)
    ...
    __swig_getmethods__["labelType"] = lambda x: _XmippData.MDL_labelType
    if _newclass:labelType = staticmethod(_XmippData.MDL_labelType)
    def __init__(self, *args): 
...
MDL_labelType = _XmippData.MDL_labelType

class MDLabelStaticInit(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, MDLabelStaticInit, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, MDLabelStaticInit, name)
    def __init__(self, *args, **kwargs): raise AttributeError, "No constructor defined"
    __repr__ = _swig_repr
...
class MDValue(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, MDValue, name, value)
    __swig_getmethods__ = {}
    ...
    __swig_setmethods__["intValue"] = _XmippData.MDValue_intValue_set
    __swig_getmethods__["intValue"] = _XmippData.MDValue_intValue_get
    if _newclass:intValue = _swig_property(_XmippData.MDValue_intValue_get, _XmippData.MDValue_intValue_set)
    __swig_setmethods__["longintValue"] = _XmippData.MDValue_longintValue_set
    __swig_getmethods__["longintValue"] = _XmippData.MDValue_longintValue_get
    if _newclass:longintValue = _swig_property(_XmippData.MDValue_longintValue_get, _XmippData.MDValue_longintValue_set)
    __swig_setmethods__["doubleValue"] = _XmippData.MDValue_doubleValue_set
    __swig_getmethods__["doubleValue"] = _XmippData.MDValue_doubleValue_get
    if _newclass:doubleValue = _swig_property(_XmippData.MDValue_doubleValue_get, _XmippData.MDValue_doubleValue_set)
    __swig_setmethods__["stringValue"] = _XmippData.MDValue_stringValue_set
    __swig_getmethods__["stringValue"] = _XmippData.MDValue_stringValue_get
    if _newclass:stringValue = _swig_property(_XmippData.MDValue_stringValue_get, _XmippData.MDValue_stringValue_set)
    __swig_setmethods__["vectorValue"] = _XmippData.MDValue_vectorValue_set
    __swig_getmethods__["vectorValue"] = _XmippData.MDValue_vectorValue_get
    if _newclass:vectorValue = _swig_property(_XmippData.MDValue_vectorValue_get, _XmippData.MDValue_vectorValue_set)
    __swig_setmethods__["label"] = _XmippData.MDValue_label_set
    __swig_getmethods__["label"] = _XmippData.MDValue_label_get
    if _newclass:label = _swig_property(_XmippData.MDValue_label_get, _XmippData.MDValue_label_set)
    def labelTypeCheck(*args): return _XmippData.MDValue_labelTypeCheck(*args)
    def __init__(self, *args): 
        this = _XmippData.new_MDValue(*args)
        try: self.this.append(this)
        except: self.this = this
    def getValue(*args): return _XmippData.MDValue_getValue(*args)
    def toStream(*args): return _XmippData.MDValue_toStream(*args)
    def toString(*args): return _XmippData.MDValue_toString(*args)
    def fromStream(*args): return _XmippData.MDValue_fromStream(*args)
    def fromString(*args): return _XmippData.MDValue_fromString(*args)
    __swig_destroy__ = _XmippData.delete_MDValue
    __del__ = lambda self : None;
MDValue_swigregister = _XmippData.MDValue_swigregister
MDValue_swigregister(MDValue)
