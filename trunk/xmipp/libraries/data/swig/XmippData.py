...
class MetaData(_object):
    ...
    def angleRot(self, *args): return _XmippData.MetaData_angleRot(self, *args)
    def angleTilt(self, *args): return _XmippData.MetaData_angleTilt(self, *args)
    def anglePsi(self, *args): return _XmippData.MetaData_anglePsi(self, *args)
    def shiftX(self, *args): return _XmippData.MetaData_shiftX(self, *args)
    def shiftY(self, *args): return _XmippData.MetaData_shiftY(self, *args)
    def shiftZ(self, *args): return _XmippData.MetaData_shiftZ(self, *args)
    def originX(self, *args): return _XmippData.MetaData_originX(self, *args)
    def originY(self, *args): return _XmippData.MetaData_originY(self, *args)
    def originZ(self, *args): return _XmippData.MetaData_originZ(self, *args)
    def weight(self, *args): return _XmippData.MetaData_weight(self, *args)
    def flip(self, *args): return _XmippData.MetaData_flip(self, *args)
    def maxCC(self, *args): return _XmippData.MetaData_maxCC(self, *args)
    def pMax(self, *args): return _XmippData.MetaData_pMax(self, *args)
    def ref(self, *args): return _XmippData.MetaData_ref(self, *args)
    def enabled(self, *args): return _XmippData.MetaData_enabled(self, *args)
    def CTFModel(self, *args): return _XmippData.MetaData_CTFModel(self, *args)
    def image(self, *args): return _XmippData.MetaData_image(self, *args)
    def micrograph(self, *args): return _XmippData.MetaData_micrograph(self, *args)
    def CTFInputParams(self, *args): return _XmippData.MetaData_CTFInputParams(self, *args)
    def periodogram(self, *args): return _XmippData.MetaData_periodogram(self, *args)
    def serie(self, *args): return _XmippData.MetaData_serie(self, *args)
    def setAngleRot(self, *args): return _XmippData.MetaData_setAngleRot(self, *args)
    def setAngleTilt(self, *args): return _XmippData.MetaData_setAngleTilt(self, *args)
    def setAnglePsi(self, *args): return _XmippData.MetaData_setAnglePsi(self, *args)
    def setEnabled(self, *args): return _XmippData.MetaData_setEnabled(self, *args)
    def setShiftX(self, *args): return _XmippData.MetaData_setShiftX(self, *args)
    def setShiftY(self, *args): return _XmippData.MetaData_setShiftY(self, *args)
    def setShiftZ(self, *args): return _XmippData.MetaData_setShiftZ(self, *args)
    def setOriginX(self, *args): return _XmippData.MetaData_setOriginX(self, *args)
    def setOriginY(self, *args): return _XmippData.MetaData_setOriginY(self, *args)
    def setOriginZ(self, *args): return _XmippData.MetaData_setOriginZ(self, *args)
    def setPMax(self, *args): return _XmippData.MetaData_setPMax(self, *args)
    def setImage(self, *args): return _XmippData.MetaData_setImage(self, *args)
    def setCTFModel(self, *args): return _XmippData.MetaData_setCTFModel(self, *args)
    def setMicrograph(self, *args): return _XmippData.MetaData_setMicrograph(self, *args)
    def setCTFInputParams(self, *args): return _XmippData.MetaData_setCTFInputParams(self, *args)
    def setPeriodogram(self, *args): return _XmippData.MetaData_setPeriodogram(self, *args)
    def setSerie(self, *args): return _XmippData.MetaData_setSerie(self, *args)
    def setWeight(self, *args): return _XmippData.MetaData_setWeight(self, *args)
    def setFlip(self, *args): return _XmippData.MetaData_setFlip(self, *args)
    def setMaxCC(self, *args): return _XmippData.MetaData_setMaxCC(self, *args)
    def setRef(self, *args): return _XmippData.MetaData_setRef(self, *args)
...
class MetaDataContainer(_object):
    ...
    __repr__ = _swig_repr
    def __init__(self): 
        this = _XmippData.new_MetaDataContainer()
        try: self.this.append(this)
        except: self.this = this
