...
class MetaData(_object):
    ...
    def shiftX(*args): return _XmippData.MetaData_shiftX(*args)
    def shiftY(*args): return _XmippData.MetaData_shiftY(*args)
    def shiftZ(*args): return _XmippData.MetaData_shiftZ(*args)
    def originX(*args): return _XmippData.MetaData_originX(*args)
    def originY(*args): return _XmippData.MetaData_originY(*args)
    def originZ(*args): return _XmippData.MetaData_originZ(*args)
    def weight(*args): return _XmippData.MetaData_weight(*args)
    def flip(*args): return _XmippData.MetaData_flip(*args)
    def maxCC(*args): return _XmippData.MetaData_maxCC(*args)
    def pMax(*args): return _XmippData.MetaData_pMax(*args)
    def ref(*args): return _XmippData.MetaData_ref(*args)
    def enabled(*args): return _XmippData.MetaData_enabled(*args)
    def CTFModel(*args): return _XmippData.MetaData_CTFModel(*args)
    def image(*args): return _XmippData.MetaData_image(*args)
    def micrograph(*args): return _XmippData.MetaData_micrograph(*args)
    def CTFInputParams(*args): return _XmippData.MetaData_CTFInputParams(*args)
    def periodogram(*args): return _XmippData.MetaData_periodogram(*args)
    def serie(*args): return _XmippData.MetaData_serie(*args)
    def setAngleRot(*args): return _XmippData.MetaData_setAngleRot(*args)
    def setAngleTilt(*args): return _XmippData.MetaData_setAngleTilt(*args)
    def setAnglePsi(*args): return _XmippData.MetaData_setAnglePsi(*args)
    def setEnabled(*args): return _XmippData.MetaData_setEnabled(*args)
    def setShiftX(*args): return _XmippData.MetaData_setShiftX(*args)
    def setShiftY(*args): return _XmippData.MetaData_setShiftY(*args)
    def setShiftZ(*args): return _XmippData.MetaData_setShiftZ(*args)
    def setOriginX(*args): return _XmippData.MetaData_setOriginX(*args)
    def setOriginY(*args): return _XmippData.MetaData_setOriginY(*args)
    def setOriginZ(*args): return _XmippData.MetaData_setOriginZ(*args)
    def setPMax(*args): return _XmippData.MetaData_setPMax(*args)
    def setImage(*args): return _XmippData.MetaData_setImage(*args)
    def setCTFModel(*args): return _XmippData.MetaData_setCTFModel(*args)
    def setMicrograph(*args): return _XmippData.MetaData_setMicrograph(*args)
    def setCTFInputParams(*args): return _XmippData.MetaData_setCTFInputParams(*args)
    def setPeriodogram(*args): return _XmippData.MetaData_setPeriodogram(*args)
    def setSerie(*args): return _XmippData.MetaData_setSerie(*args)
    def setWeight(*args): return _XmippData.MetaData_setWeight(*args)
