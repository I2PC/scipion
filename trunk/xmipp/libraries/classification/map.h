...
class xmippMap : public xmippCB
{
 public:
   ...
   */
  friend ostream& operator << (ostream& _os, const xmippMap& _som) { _som.printSelf(_os);};
   ...
   * @exception  runtime_error  If there are problems with the stream
   */
  friend istream& operator >> (istream& _is, xmippMap& _som) {_som.readSelf(_is);};
...
class xmippFuzzyMap : public xmippFCB
{
 public:
   ...
   * @param _som  The som to be printed
   */
  friend ostream& operator << (ostream& _os, const xmippFuzzyMap& _fsom) { _fsom.printSelf(_os); };
   ...
   * @exception  runtime_error  If there are problems with the stream
   */
  friend istream& operator >> (istream& _is, xmippFuzzyMap& _fsom) { _fsom.readSelf(_is); };
