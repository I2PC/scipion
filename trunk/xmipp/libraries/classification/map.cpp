...
*/
   ...
   */
  const string& xmippMap::layout() const { return somLayout->id(); };
   ...
   */
  unsigned xmippMap::width() const { return somWidth; };

  /**
   * Returns the height of the SOM
   */
  unsigned xmippMap::height() const { return somHeight; };
...
/*  IT DOESN'T WORK PROPERLY   
  ...
  void xmippMap::loadObject(istream& _is)
  {
     ...
     */
    const string& Layout::id() const { return theId; };
...
*/
   ...
   * Returns the id of layout that som has
   */
  const string& xmippFuzzyMap::layout() const { return somLayout->id(); };
   ...
   * Returns the width of the SOM
   */
  unsigned xmippFuzzyMap::width() const { return somWidth; };

  /**
   * Returns the height of the SOM
   */
  unsigned xmippFuzzyMap::height() const { return somHeight; };
