...
public class XmippMenuBar extends DynamicMenuBar implements ActionListener {
    ...
    // *** Transform ***
    private Menu menuTransform = new Menu(XmippLabel.OPERATION_MENU_TRANSFORM);
    private MenuItem itemToTable = new MenuItem(XmippLabel.OPERATION_TO_GALLERY);
    private Menu menuFlip = new Menu(XmippLabel.OPERATION_MENU_FLIP);
    private MenuItem itemFlipV = new MenuItem(XmippLabel.OPERATION_FLIP_VERTICAL);
    private MenuItem itemFlipH = new MenuItem(XmippLabel.OPERATION_FLIP_HORIZONTAL);
    private Menu menuRotate = new Menu(XmippLabel.OPERATION_MENU_ROTATE);
    private MenuItem itemRotateL = new MenuItem(XmippLabel.OPERATION_ROTATE_LEFT);
    private MenuItem itemRotateR = new MenuItem(XmippLabel.OPERATION_ROTATE_RIGHT);
    private MenuItem itemCrop = new MenuItem(XmippLabel.OPERATION_CROP);
    private Menu menuReslice = new Menu(XmippLabel.LABEL_RESLICE);
    private MenuItem itemResliceTop = new MenuItem(XmippLabel.OPERATION_RESLICE_TOP);
    private MenuItem itemResliceRight = new MenuItem(XmippLabel.OPERATION_RESLICE_RIGHT);
    private MenuItem itemStackSlicer = new MenuItem(XmippLabel.OPERATION_STACK_SLICER);
    private MenuItem itemRadialReslice = new MenuItem(XmippLabel.OPERATION_RADIAL_RESLICE);
    private MenuItem itemStraightenCurvedObjects = new MenuItem(XmippLabel.OPERATION_STRAIGHTEN_CURVED_OBJECTS);
    private MenuItem itemUntiltStack = new MenuItem(XmippLabel.OPERATION_UNTILT_STACK);
    private Menu menuTransformJ = new Menu(XmippLabel.OPERATION_TRANSFORMJ);
    private MenuItem itemTJAbout = new MenuItem(XmippLabel.OPERATION_TJABOUT);
    private MenuItem itemTJAffine = new MenuItem(XmippLabel.OPERATION_TJAFFINE);
    private MenuItem itemTJCrop = new MenuItem(XmippLabel.OPERATION_TJCROP);
    private MenuItem itemTJEmbed = new MenuItem(XmippLabel.OPERATION_TJEMBED);
    private MenuItem itemTJMirror = new MenuItem(XmippLabel.OPERATION_TJMIRROR);
    private MenuItem itemTJOptions = new MenuItem(XmippLabel.OPERATION_TJOPTIONS);
    private MenuItem itemTJPanel = new MenuItem(XmippLabel.OPERATION_TJPANEL);
    private MenuItem itemTJRotate = new MenuItem(XmippLabel.OPERATION_TJROTATE);
    private MenuItem itemTJScale = new MenuItem(XmippLabel.OPERATION_TJSCALE);
    private MenuItem itemTJShift = new MenuItem(XmippLabel.OPERATION_TJSHIFT);
    private MenuItem itemTJTurn = new MenuItem(XmippLabel.OPERATION_TJTURN);
    private MenuItem itemTJWebsite = new MenuItem(XmippLabel.OPERATION_TJWEBSITE);
    private MenuItem itemSurfaceJ = new MenuItem(XmippLabel.OPERATION_SURFACEJ);
    // *** Denoising ***
    private Menu menuDenoising = new Menu(XmippLabel.OPERATION_MENU_DENOISING);
    private MenuItem itemFFT_band_pass_filter = new MenuItem(XmippLabel.OPERATION_FFT_BAND_PASS_FILTER);
    private MenuItem itemAnisotropicDiffusion = new MenuItem(XmippLabel.OPERATION_ANISOTROPIC_DIFFUSION);
    private MenuItem itemMeanShiftFilter = new MenuItem(XmippLabel.OPERATION_MEAN_SHIFT_FILTER);
    // *** Open with ***
    private Menu menuOpenWith = new Menu(XmippLabel.OPERATION_MENU_OPEN_WITH);
    private MenuItem item3DViewer = new MenuItem(XmippLabel.OPERATION_OPEN_AS_3D);
    private MenuItem itemVolumeViewer3DSlicer = new MenuItem(XmippLabel.OPERATION_VOLUME_VIEWER_3D_SLICER);
    private MenuItem itemVolumeJ = new MenuItem(XmippLabel.OPERATION_VOLUMEJ);
    // *** Info ***
    private Menu menuInfo = new Menu(XmippLabel.OPERATION_MENU_INFO);
    private CheckboxMenuItem itemPoll = new CheckboxMenuItem(XmippLabel.OPERATION_POLL);
    private MenuItem itemDuplicate = new MenuItem(XmippLabel.OPERATION_DUPLICATE);
    private MenuItem itemGoToSlice = new MenuItem(XmippLabel.OPERATION_GO_TO_SLICE);
    private MenuItem itemSubstackMaker = new MenuItem(XmippLabel.OPERATION_SUBSTACK_MAKER);
    private MenuItem itemHistogram = new MenuItem(XmippLabel.OPERATION_HISTOGRAM);
    private MenuItem itemPlotProfile = new MenuItem(XmippLabel.OPERATION_PLOT_PROFILE);
    private MenuItem itemMeasurements = new MenuItem(XmippLabel.OPERATION_MEASUREMENTS);
    private MenuItem itemAutocorrelation = new MenuItem(XmippLabel.OPERATION_AUTOCORRELATION);
    private MenuItem itemConcentricCircles = new MenuItem(XmippLabel.OPERATION_CONCENTRIC_CIRCLES);
    private MenuItem itemLineAnalyzer = new MenuItem(XmippLabel.OPERATION_LINE_ANALYZER);
    private MenuItem itemOvalProfilePlot = new MenuItem(XmippLabel.OPERATION_OVAL_PROFILER_PLOT);
    private MenuItem itemRadialProfilePlotAngle = new MenuItem(XmippLabel.OPERATION_RADIAL_PROFILE_PLOT_ANGLE);
    private MenuItem itemRadialProfilePlotHeight = new MenuItem(XmippLabel.OPERATION_RADIAL_PROFILE_PLOT_HEIGHT);
    private MenuItem itemContourPlotter = new MenuItem(XmippLabel.OPERATION_CONTOUR_PLOTTER);
    private MenuItem itemFeatureJ = new MenuItem(XmippLabel.OPERATION_FEATUREJ);
    private MenuItem itemSyncWindows = new MenuItem(XmippLabel.OPERATION_SYNC_WINDOWS);
    private MenuItem itemSyncMeasure3D = new MenuItem(XmippLabel.OPERATION_SYNC_MEASURE_3D);
    // *** Thresholding ***
    private Menu menuThresholding = new Menu(XmippLabel.OPERATION_MENU_THRESHOLDING);
    private MenuItem itemThreshold = new MenuItem(XmippLabel.OPERATION_THRESHOLD);
    private MenuItem itemOtsuThresholding = new MenuItem(XmippLabel.OPERATION_OTSU_THRESHOLDING);
    private MenuItem itemMultiOtsuThreshold = new MenuItem(XmippLabel.OPERATION_MULTI_OTSU_THRESHOLDING);
    private MenuItem itemMixtureModelingThresholding = new MenuItem(XmippLabel.OPERATION_MIXTURE_MODELING_THRESHOLDING);
    private MenuItem itemMaximumEntropyThresholding = new MenuItem(XmippLabel.OPERATION_MAXIMUM_ENTROPY_THRESHOLDING);
    private MenuItem itemMultiThresholder = new MenuItem(XmippLabel.OPERATION_MULTI_THRESHOLDER);
    private MenuItem itemSIOX = new MenuItem(XmippLabel.OPERATION_SIOX);
    private MenuItem itemRATS = new MenuItem(XmippLabel.OPERATION_RATS);
    // *** Binary ***
    private Menu menuBinary = new Menu(XmippLabel.OPERATION_MENU_BINARY);
    private MenuItem itemVoxelCounter = new MenuItem(XmippLabel.OPERATION_VOXEL_COUNTER);
    private MenuItem itemErode = new MenuItem(XmippLabel.OPERATION_ERODE);
    private MenuItem itemDilate = new MenuItem(XmippLabel.OPERATION_DILATE);
    private MenuItem itemOpen = new MenuItem(XmippLabel.OPERATION_OPEN);
    private MenuItem itemClose = new MenuItem(XmippLabel.OPERATION_CLOSE);
    private MenuItem itemFloatMorphology = new MenuItem(XmippLabel.OPERATION_FLOAT_MORPHOLOGY);
    private MenuItem itemOutline = new MenuItem(XmippLabel.OPERATION_OUTLINE);
    private MenuItem itemFillHoles = new MenuItem(XmippLabel.OPERATION_FILL_HOLES);
    private MenuItem itemSkeletonize = new MenuItem(XmippLabel.OPERATION_SKELETONIZE);
    private MenuItem itemDistanceMap = new MenuItem(XmippLabel.OPERATION_DISTANCE_MAP);
    private MenuItem itemUltimatePoints = new MenuItem(XmippLabel.OPERATION_ULTIMATE_POINTS);
    private MenuItem itemWatershed = new MenuItem(XmippLabel.OPERATION_WATERSHED);
    private MenuItem itemVoronoi = new MenuItem(XmippLabel.OPERATION_VORONOI);
    private MenuItem itemOptions = new MenuItem(XmippLabel.OPERATION_OPTIONS);
    // *** Process ***
    private Menu menuProcess = new Menu(XmippLabel.OPERATION_MENU_PROCESS);
    private MenuItem itemBC = new MenuItem(XmippLabel.OPERATION_BC);
    private MenuItem itemEnhanceContrast = new MenuItem(XmippLabel.OPERATION_ENHANCE_CONTRAST);
    private MenuItem itemSubtractBG = new MenuItem(XmippLabel.OPERATION_SUBTRACTBG);
    private MenuItem itemGaussianBlur = new MenuItem(XmippLabel.OPERATION_GAUSSIAN_BLUR);
    private MenuItem itemConvolve = new MenuItem(XmippLabel.OPERATION_CONVOLVE);
    private MenuItem itemMedian = new MenuItem(XmippLabel.OPERATION_MEDIAN);
    private MenuItem itemMean = new MenuItem(XmippLabel.OPERATION_MEAN);
    private MenuItem itemFFT = new MenuItem(XmippLabel.OPERATION_FFT);
    private MenuItem itemCLAHE = new MenuItem(XmippLabel.OPERATION_CLAHE);
    private MenuItem itemPCA = new MenuItem(XmippLabel.OPERATION_PCA);
    private MenuItem itemPolarTransformer = new MenuItem(XmippLabel.OPERATION_POLAR_TRANSFORMER);
    private MenuItem itemTemplateMatching = new MenuItem(XmippLabel.OPERATION_TEMPLATE_MATCHING);
    // *** Draw ***
    private Menu menuDraw = new Menu(XmippLabel.OPERATION_MENU_DRAW);
    private MenuItem itemDottedandDashedLines = new MenuItem(XmippLabel.OPERATION_DOTTED_AND_DASHED_LINES);
    private MenuItem itemRadialGrid = new MenuItem(XmippLabel.OPERATION_RADIAL_GRID);
    // *** Masks ***
    private Menu menuMasks = new Menu(XmippLabel.OPERATION_MENU_MASKS);
    private MenuItem itemMasksToolBar = new MenuItem(XmippLabel.OPERATION_MASKS_TOOLBAR);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        try {
            if (e.getSource() == itemToTable) {
                ...
                GenericDialog dialog = new GenericDialog(XmippLabel.TITLE_GO_TO_SLICE);
