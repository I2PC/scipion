...
public class MDLabel {
   ...
   public static final int MDL_NOISE_COORD = 138;  //Use instead of MDL_NOISE_PARTICLE_COORD in future ///
   ...
   public static final int MDL_DIMENSIONS_3D = 154;  // X = 154;Y = 154;Z dimensions ///
   public static final int MDL_DIMENSIONS_2D = 155;  // X = 155;Y dimensions ///
   public static final int MDL_PSD = 156;  ///< A Power Spectrum Density file name (std::string)
   public static final int MDL_PSD_ENHANCED = 157;  ///< A enhanced Power Spectrum Density file name (std::string)
   public static final int MDL_RANDOMSEED = 158;  ///< Seed for random number generator
   public static final int MDL_REF3D = 159;  ///< 3D Class to which the image belongs (int)
   public static final int MDL_REF = 160;  ///< Class to which the image belongs (int)
   public static final int MDL_REFMD = 161;  ///< Name of Metadata file for all references(string)
   public static final int MDL_RESOLUTION_DPR = 162;  ///<differential phase residual (double)
   public static final int MDL_RESOLUTION_ERRORL2 = 163;  ///<Error in l2 (double)
   public static final int MDL_RESOLUTION_FRC = 164;  ///<Fourier shell correlation (double)
   public static final int MDL_RESOLUTION_FRCRANDOMNOISE = 165;  ///<Fourier shell correlation noise (double)
   public static final int MDL_RESOLUTION_FREQ = 166;  ///<Frequency in 1/A (double)
   public static final int MDL_RESOLUTION_FREQREAL = 167;  ///< Frequency in A (double)
   public static final int MDL_SAMPLINGRATE = 168;  ///< sampling rate in A/pixel (double)
   public static final int MDL_SAMPLINGRATEX = 169;  ///< sampling rate in A/pixel (double)
   public static final int MDL_SAMPLINGRATEY = 170;  ///< sampling rate in A/pixel (double)
   public static final int MDL_SAMPLINGRATEZ = 171;  ///< sampling rate in A/pixel (double)
   public static final int MDL_SCALE = 172;  ///< scaling factor for an image or volume (double)
   public static final int MDL_SELFILE = 173;  ///< Name of an image (std::string)
   public static final int MDL_SERIE = 174;  ///< A collection of micrographs, e.g. a tilt serie (std::string)
   public static final int MDL_SHIFTX = 175;  ///< Shift for the image in the X axis (double)
   public static final int MDL_SHIFTY = 176;  ///< Shift for the image in the Y axis (double)
   public static final int MDL_SHIFTZ = 177;  ///< Shift for the image in the Z axis (double)
   public static final int MDL_SHIFT_CRYSTALX = 178;  ///< Shift for the image in the X axis (double) for crystals
   public static final int MDL_SHIFT_CRYSTALY = 179;  ///< Shift for the image in the Y axis (double) for crystals
   public static final int MDL_SHIFT_CRYSTALZ = 180;  ///< Shift for the image in the Z axis (double) for crystals
   public static final int MDL_SIGMANOISE = 181;  ///< Standard deviation of the noise in ML model
   public static final int MDL_SIGMAOFFSET = 182;  ///< Standard deviation of the offsets in ML model
   public static final int MDL_SIGNALCHANGE = 183;  ///< Signal change for an image
   public static final int MDL_SPHERICALABERRATION = 184;  ///<ctf definition azimutal angle
   public static final int MDL_STDDEV = 185;  ///<stdandard deviation value (double)
   public static final int MDL_SUM = 186;  ///< Sum of elements of a given type (double) [this is a genereic type do not use to transfer information to another program]
   public static final int MDL_SUMWEIGHT = 187;  ///< Sum of all weights in ML model
   public static final int MDL_SYMNO = 188;  ///< Symmetry number for a projection (used in ART)
   public static final int MDL_TRANSFORMATIONMTRIX = 189;  ///< transformation matrix(vector double)
   public static final int MDL_VOLTAGE = 190;  ///< microscope voltage (double)
   public static final int MDL_WEIGHT = 191;  ///< Weight assigned to the image (double)
   public static final int MDL_WROBUST = 192;  ///< Weight of t-student distribution in robust Maximum likelihood
   public static final int MDL_X = 193;  ///< X component (double)
   public static final int MDL_XINT = 194;  ///< X component (int)
   public static final int MDL_XINTTILT = 195;  ///< X component in tilted micrograph (int)
   public static final int MDL_XSIZE = 196;  ///< X size (int)
   public static final int MDL_Y = 197;  ///< Y component (double)
   public static final int MDL_YINT = 198;  ///< Y component (int)
   public static final int MDL_YINTTILT = 199;  ///< Y component in tilted micrograph (int)
   public static final int MDL_YSIZE = 200;  ///< Y size (int)
   public static final int MDL_Z = 201;  ///< Z component (double)
   public static final int MDL_ZINT = 202;  ///< Z component (int)
   public static final int MDL_ZSCORE = 203;  ///< Z Score (double)
   public static final int MDL_ZSIZE = 204;  ///< Z size (int)
   public static final int MDL_PHANTOM_BGDENSITY = 205;  ///< Phantom background density (double)
   public static final int MDL_PHANTOM_SCALE = 206;  ///< Number which will multiply all features (double)
   public static final int MDL_PHANTOM_FEATURE_TYPE = 207;  ///< Type of the feature (Sphere, Blob, ...) (std::string)
   public static final int MDL_PHANTOM_FEATURE_OPERATION = 208;  ///< Operation in case of overlapping features (+,-)
   public static final int MDL_PHANTOM_FEATURE_DENSITY = 209;  ///< The density of the feature (double)
   public static final int MDL_PHANTOM_FEATURE_CENTER = 210;  ///< Center of the feature (vector double)
   public static final int MDL_PHANTOM_FEATURE_SPECIFIC = 211;  ///< Specific parameters for a feature (vector double)
   public static final int MDL_PRJ_ANGFILE = 212;   ///< File for generated angles
   public static final int MDL_PRJ_ROT_RANGE = 213; ///
   public static final int MDL_PRJ_ROT_Noise  = 214;   /// < Rotational angle dev and mean noise (vector double)
   public static final int MDL_PRJ_ROT_RANDSTR = 215;   /// < Type of randomness for Rotational (std::string)
   public static final int MDL_PRJ_TILT_Noise = 216;   /// < Tilt angle dev and mean noise (vector double)
   public static final int MDL_PRJ_TILT_RANDSTR = 217;   /// < Type of randomness for Tilt (std::string)
   public static final int MDL_PRJ_PSI_RANGE = 218;   /// < Psi angle range (vector double)
   public static final int MDL_PRJ_PSI_Noise = 219;   /// < Psi angle dev and mean noise (vector double)
   public static final int MDL_PRJ_PSI_RANDSTR = 220;  /// < Type of randomness for Psi (std::string)
   public static final int MDL_2D_LATTICE_VECA = 221;    /// < Lattice vector for projection (vector double)
   public static final int MDL_2D_LATTICE_VECB = 222;    /// < Lattice vector for projection (vector double)
   public static final int MDL_CRYSTAL_DISAPPEAR_THRE = 223;    /// < Disappearing threshold (double)
   public static final int MDL_CRYSTAL_SHFILE = 224;    /// < Shift file for crystal projection
   public static final int MDL_ORTHOGONAL_PROJECTION = 225;    /// <Orthogonal projection or not (bool)
   public static final int MDL_CRYSTAL_PROJ = 226;    /// < Have a crystal projection (boo)
   public static final int MDL_LAST_LABEL = 227;  // **** NOTE ****: Do keep this label always at the end;it is here for looping purposes ///
}
