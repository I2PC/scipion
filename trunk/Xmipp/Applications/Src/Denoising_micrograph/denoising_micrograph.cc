/***************************************************************************
 *
 * Authors:     Carlos Oscar S. Sorzano (coss@cnb.uam.es) (2002)
 *
...
int main (int argc, char **argv) {
   ...
   try {
      ...
      // Create output image
      cerr << "Creating output micrograph ...\n";
      create_empty_file(fn_out,Ydim*Xdim*bits/8);
      ...
      fh_inf << "# Image width\n";
      fh_inf << "Xdim=" << Xdim << endl;
      fh_inf << "# Image length\n";
      fh_inf << "Ydim=" << Ydim << endl;
      fh_inf << "# Pixel depth\n";
      ...
      for (int I=0; I<Ypieces; I++)
	    ...
	    if (iF>=Ydim) {
	       iF=Ydim-1;
	       i0=iF-window_size+1; if (i0<0) i0=0;
	    }
	    if (jF>=Xdim) {
	       jF=Xdim-1;
