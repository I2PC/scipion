...
public:
  ...
  void quadrant_stats(ImageXmipp &img, 
    ...
    XX(corner2)=0;         YY(corner2)=0;
    img().compute_stats(mean,stddev,minval,maxval,corner1,corner2);
    sum2_quadmean+=mean*mean;
    sum_quadmean+=mean;
    sum2_quadsig+=stddev*stddev;
    sum_quadsig+=stddev;
    XX(corner1)=STARTINGX(img());    YY(corner1)=0;
    XX(corner2)=0;         YY(corner2)=FINISHINGY(img());
    img().compute_stats(mean,stddev,minval,maxval,corner1,corner2);
    sum2_quadmean+=mean*mean;
    sum_quadmean+=mean;
    sum2_quadsig+=stddev*stddev;
    sum_quadsig+=stddev;
    XX(corner1)=0;         YY(corner1)=STARTINGY(img());
    XX(corner2)=FINISHINGX(img());     YY(corner2)=0;
    img().compute_stats(mean,stddev,minval,maxval,corner1,corner2);
    sum2_quadmean+=mean*mean;
    sum_quadmean+=mean;
    sum2_quadsig+=stddev*stddev;
    sum_quadsig+=stddev;
    XX(corner1)=0;         YY(corner1)=0;
    XX(corner2)=FINISHINGX(img());     YY(corner2)=FINISHINGX(img());
    img().compute_stats(mean,stddev,minval,maxval,corner1,corner2);
    sum2_quadmean+=mean*mean;
    sum_quadmean+=mean;
    sum2_quadsig+=stddev*stddev;
