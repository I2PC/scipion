...
void CTFViewer::changeVar() {
   ...
   switch (SelecVar->currentItem()) {
      ...
      case  4: ctf.espr=val;         break;
      case  5: ctf.ispr=val;         break;
      case  6: ctf.alpha=val;        break;
      case  7: ctf.DeltaF=val;       break;
      case  8: ctf.DeltaR=val;       break;
      case  9: ctf.Q0=val;           break;
      case 10: ctf.K=val;            break;
      case 11: ctf.gaussian_K=val;   break;
      case 12: ctf.sigmaU=val;       break;
      case 13: ctf.sigmaV=val;       break;
      case 14: ctf.cU=val;           break;
      case 15: ctf.cV=val;           break;
      case 16: ctf.rad_gaussian=val; break;
      case 17: ctf.sqrt_K=val;       break;
      case 18: ctf.sqU=val;          break;
      case 19: ctf.sqV=val;          break;
      case 20: ctf.sqrt_angle=val;   break;
      case 21: ctf.base_line=val;    break;
   }
   generate_ctfmodel();
}
...
void CTFViewer::setVar(int e) {
   if (!ctf_valid) return;
   switch (e) {
      case  0: lineEditVar->setText(QString::number(ctf.Tm          ,'f',6));  break;
      case  1: lineEditVar->setText(QString::number(ctf.kV          ,'f',6));  break;
      case  2: lineEditVar->setText(QString::number(ctf.Cs          ,'f',6));  break;
      case  3: lineEditVar->setText(QString::number(ctf.Ca          ,'f',6));  break;
      case  4: lineEditVar->setText(QString::number(ctf.espr        ,'f',6));  break;
      case  5: lineEditVar->setText(QString::number(ctf.ispr        ,'f',6));  break;
      case  6: lineEditVar->setText(QString::number(ctf.alpha       ,'f',6));  break;
      case  7: lineEditVar->setText(QString::number(ctf.DeltaF      ,'f',6));  break;
      case  8: lineEditVar->setText(QString::number(ctf.DeltaR      ,'f',6));  break;
      case  9: lineEditVar->setText(QString::number(ctf.Q0          ,'f',6));  break;
      case 10: lineEditVar->setText(QString::number(ctf.K           ,'f',6));  break;
      case 11: lineEditVar->setText(QString::number(ctf.gaussian_K  ,'f',6));  break;
      case 12: lineEditVar->setText(QString::number(ctf.sigmaU      ,'f',6));  break;
      case 13: lineEditVar->setText(QString::number(ctf.sigmaV      ,'f',6));  break;
      case 14: lineEditVar->setText(QString::number(ctf.cU          ,'f',6));  break;
      case 15: lineEditVar->setText(QString::number(ctf.cV          ,'f',6));  break;
      case 16: lineEditVar->setText(QString::number(ctf.rad_gaussian,'f',6));  break;
      case 17: lineEditVar->setText(QString::number(ctf.sqrt_K      ,'f',6));  break;
      case 18: lineEditVar->setText(QString::number(ctf.sqU         ,'f',6));  break;
      case 19: lineEditVar->setText(QString::number(ctf.sqV         ,'f',6));  break;
      case 20: lineEditVar->setText(QString::number(ctf.sqrt_angle  ,'f',6));  break;
      case 21: lineEditVar->setText(QString::number(ctf.base_line   ,'f',6));  break;
   }
   generate_ctfmodel();
}
...
void CTFViewer::recomputeCurves() {
    ...
    getCTFcurve("pure",angle,data);       plotter.setCurveData(1,data);
    getCTFcurve("damping",angle,data);    plotter.setCurveData(2,data);
    getCTFcurve("background",angle,data); plotter.setCurveData(3,data);
    getExperimentalCurve(angle,data);     plotter.setCurveData(4,data);
    refreshCurves();
}
...
void CTFViewer::changeMainCTFVariables() {
   ...
   val=lineEditDfU->text().toDouble(&Ok);
      if (Ok) ctf.DeltafU=val; else return;
   val=lineEditDfV->text().toDouble(&Ok);
      if (Ok) ctf.DeltafV=val; else return;
   val=lineEditAzi->text().toDouble(&Ok);
      if (Ok) ctf.azimuthal_angle=val; else return;
   generate_ctfmodel();
}
