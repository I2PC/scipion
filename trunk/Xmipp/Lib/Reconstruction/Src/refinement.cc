...
//       #define DEBUG_calculate_and_find_correlation_max_mat
       ...
       cout << "\n  jj_max   "   << jj_max   <<endl;
       cout << "\n  ii_max   "   << ii_max   <<endl;
       cout << "\n  sum_corr "   << sum_corr <<endl; cout.flush();
       #endif
...
/* Instantiate ------------------------------------------------------------- */
template <class T>
void instantiate_Refinement(matrix2D<T> m) {
      double d;
      calculate_and_find_correlation_max_mat(m,m,m,d,d,d);
}
void instantiate_Refinement() {
   matrix2D<double> m;
   instantiate_Refinement(m);
}
