...
/** Mass of a Blob.
    ...
    See \Ref{Feature::volume} */
    double volume() const {return basvolume (radius, alpha, m, 3);}
///
...
/** Volume of a cylinder.
    ...
    See \Ref{Feature::volume} */
    double volume() const {return 4/3*PI*xradius*yradius*height;}
...
/** Volume of a double cylinder.
    ...
    See \Ref{Feature::volume} */
    double volume() const {return 2* 4/3*PI*radius*radius*height;}
...
/** Volume of an ellipsoid.
    ...
    See \Ref{Feature::volume} */
    double volume() const {return 4/3*PI*xradius*yradius*zradius;}
...
/** Volume of a cone.
    ...
    See \Ref{Feature::volume} */
    double volume() const {return 1/3*PI*radius*radius*height;}
...
/** Construct from a phantom file.
    ...
    Phantom(const FileName &fn_phantom) {read(fn_phantom);}
...
/** Constant Access to a feature pointer.
    ...
    const Feature * operator ()(int i) const {return VF[i-1];}
...
/** Add a feature to the phantom.
    ...
    void add(Feature *f) {VF.push_back(f);}
