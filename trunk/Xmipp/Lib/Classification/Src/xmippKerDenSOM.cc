...
//-----------------------------------------------------------------------------
   ...
   */
  void xmippKerDenSOM::nSteps(const unsigned long& _nSteps) { somNSteps = _nSteps; };

  /**
   * Gets the sigma (Kernel Width)
   */
  double xmippKerDenSOM::getSigma() { return sigma; };
...
//-----------------------------------------------------------------------------
   ...
   */
  void xmippKerDenSOM::setAnnSteps(const unsigned long& _annSteps) {annSteps = _annSteps;};
