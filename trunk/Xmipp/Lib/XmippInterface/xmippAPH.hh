...
/** Copy reflection. Copy a reflection from (h,k) to (new_h,new_k). The
    associated information is also copied (IQ, background and CTF). The sign of
    the new reflection can be modified through sign. If sign is an even number,
    no sign change is performed. Otherwise, the sign of the spot is changed (a
    phase change of 180 degrees).
    
    The phase of the original reflection can also be conjugated in order to
