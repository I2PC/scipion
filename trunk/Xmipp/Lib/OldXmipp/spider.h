...
/*2 */      float fNrow;   /* = NUMBER OF ROWS PER SLICE                     */
/*3 */      float fNrec;   /* = TOTAL NUMBER OF RECORDS (SEE NOTE #3).       */
/*4 */      float fNlabel; /* = AUXILIARY NUMBER TO COMPUTE TOTAL NUMBER     */
/*  */		              /*   OF RECS.                                     */
...
/*10*/      float fSig;    /* = STANDARD DEVIATION. A VALUE OF -1.           */
...
/*  */                    /*                                                */
/*12*/      float fNsam;   /* = NUMBER OF PIXELS PER LINE                    */
/*13*/      float fLabrec; /* = NUMBER OF LABEL RECORDS IN FILE HEADER       */
/*14*/      float fIangle; /* = FLAG THAT TILT ANGLES HAVE BEEN FILLED       */
/*15*/      float fPhi;    /* = TILT ANGLE                                   */
/*16*/      float fTheta;  /* = TILT ANGLE                                   */
/*17*/      float fGamma;  /* = PSI  = TILT ANGLE                            */
...
/*212-214*/char szIDat[12];/*= LOGICAL * 1 ARRAY DIMENSIONED 10,             */
/*  */		              /*  CONTAINING THE DATE OF CREATION               */
/*  */		              /*  (10 CHARS)                                    */
/*215-216*/char szITim[8]; /*= LOGICAL * 1 ARRAY DIMENSIONED 8,              */
