...
def isProtocolUpToDate(protocol):
    ...
    try:
        ...
        print("Can't compare if protocol is up to date: Protocol %s, protocol time stamp: %s, %s timeStamp: %s, ERROR: %s" %
              (str(protocol), str(protTS), str(protocol), str(dbTS), str(e)))
