...
def _runRemote(protocol, mode):
    ...
    tpl  = "ssh %(address)s '%(scipion)s/scipion --config /home/scipionweb/.config/movies/scipion.conf runprotocol pw_protocol_remote.py %(mode)s %(project)s %(protDb)s %(protId)s'"
