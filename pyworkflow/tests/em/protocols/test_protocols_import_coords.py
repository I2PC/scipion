...
class TestImportCoordinates(TestImportBase):
    ...
    def testImportCoordinates(self):
        ...
        protImport = self.newProtocol(ProtImportMicrographs, filesPath=self.dsXmipp.getFile('allMics'),
        ...
        # First, import a set of micrographs
        protImportGroel = self.newProtocol(ProtImportMicrographs, filesPath=self.dsGroel.getFile('mic1'),
                                           samplingRate=1)
