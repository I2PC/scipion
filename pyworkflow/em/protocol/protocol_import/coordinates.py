...
from pyworkflow.protocol.params import (IntParam, PointerParam, FloatParam,
                                        ...
                                        LEVEL_ADVANCED)
from pyworkflow.utils.path import removeBaseExt, expandPattern, exists
...
class ProtImportCoordinates(ProtImportFiles, ProtParticlePicking):
    ...
    def _summary(self):
        ...
        if not hasattr(self, 'outputCoordinates'):
            ...
            msg = "%s  coordinates from micrographs %s were imported using %s format." % (
                self.outputCoordinates.getSize(), self.getObjectTag('inputMicrographs'),
...
class ProtImportCoordinatesPairs(ProtImportFiles):
    ...
    def createOutputStep(self):
        ...
        from pyworkflow.em.packages.xmipp3.convert import writeSetOfMicrographsPairs
    ...
    def readCoordinates(self):
        ...
        if self.importFrom.get() == self.IMPORT_FROM_XMIPP:
            from pyworkflow.em.packages.xmipp3.convert import readAnglesFromMicrographs
    ...
    def _readCoordinates(self, coordsDir, suffix=''):
        ...
        tSet = micTiltPairs.getTilted()
        # Create Untilted and Tilted SetOfCoordinates
        from pyworkflow.em.packages.xmipp3.convert import readSetOfCoordinates
