...
import pyworkflow.protocol as prot
...
class XmippProtCL2DAlign(em.ProtAlign2D):
	...
	def _defineAlignParams(self, form):
		form.addParam('useReferenceImage', prot.BooleanParam, default=False,
		...
		form.addParam('referenceImage', prot.PointerParam,
					  condition='useReferenceImage',
					  pointerClass='Particle', allowsNull=True,
					  label="Reference image",
					  help='Image that will serve as class reference')
		form.addParam('maximumShift', prot.IntParam, default=10,
					  label='Maximum shift (px):')
		form.addParam('numberOfIterations', prot.IntParam, default=10,
					  expertLevel=prot.LEVEL_ADVANCED,
