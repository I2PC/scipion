...
class XmippDefML2DViewer(Form):
    ...
    def __init__(self):
        ...
        self.addParam('logLikehoodIters', BooleanParam, label="Show Log-Likehood over iterations?", default=False, 
...
class XmippML2DViewer(Viewer, EMProtocol):
    ...
    def visualize(self, obj, **args):
        ...
        w = FormWindow("Protocol Run: " + self.getClassName(), self, 
                       self._executeAll, args['windows'],
                       hostList=[])
        w.show(center=True)
        
    def _executeAll(self, *args):
