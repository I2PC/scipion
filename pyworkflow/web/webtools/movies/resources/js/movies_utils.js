...
function getRefTestData(id){
	...
	switch(id){
		case "ribosome":
			ref = "<strong>S.cereviseae 80S ribosome</strong>, 5 movies, 1.77 Å, <a href='http://dx.doi.org/10.7554/eLife.00461' style='color:firebrick;' target='_blank'>from Bai XC, Fernandez IS, McMullan G, Scheres SH</a>)"
			break;
		case "falcon":
			ref = "<strong>Influenza A ribonucleoproteins</strong>, 5 movies, 2.26 Å"
			break;
	}
	return ref;
}
