...
XMIPP_EXTERNAL = os.path.join(XMIPP_HOME, 'external')

TK_ROOT = XMIPP_LIB, os.path.join(XMIPP_EXTERNAL, "python/tk8.5.10/generic/")
TCL_ROOT = XMIPP_LIB, os.path.join(XMIPP_EXTERNAL, "python/tcl8.5.10/generic/")
JPEG_ROOT = XMIPP_LIB, os.path.join(XMIPP_EXTERNAL, "jpeg-8c/")
ZLIB_ROOT = None
TIFF_ROOT = XMIPP_LIB
