...
protocols = {
        ...
        'merge_particles': ('Merge (union)', 'Images/Merged'),
        'preprocess_particles': ('Preprocess', 'Images/Preprocessed'),
        'screen_particles': ('Screen', 'Images/Screening'),
        'subset_particles': ('Subset (intersection)', 'Images/Subset'),
        'ml2d': ('ML2D', '2D/ML2D'),
        'cl2d': ('CL2D', '2D/CL2D'),
        ...
        'denoise_particles': ('Denoise particles', '2D/DenoisedParticles'),
        ...
        'ml3d': ('ML3D', '3D/ML3D'),
        'projection_outliers': ('Identify Outliers', '3D/Outliers'),
        ...
        'saxs': ('SAXS', '3D/SAXS'),
        'relion_classify2d': ('Relion - 2D Classify ', '2D/RelionClass2D'),
        'relion_classify': ('Relion - 3D Classify ', '3D/RelionClass'),
        'relion_refine': ('Relion - Auto refine ', '3D/RelionRef'),
        'relion_postprocess': ('Relion - Postprocess ', '3D/RelionPostprocess'),
...
('Preprocessing',
   [['Micrographs', 'import_micrographs','import_movies','screen_micrographs', 'align_movies', 'downsample_micrographs'],
    ...
    ['Particles', 'extract_particles', 'import_particles', ['Other', 'preprocess_particles', 'screen_particles', 'merge_particles',
                                                            'subset_particles']]]),
('2D',
   [['Align+Classify', 'cl2d', 'ml2d', 'relion_classify2d', ['Other', 'cl2d_align', 'kerdensom', 'rotspectra', 'screen_classes','denoise_particles']]]),
('3D',
   [['Initial Model', 'rct', 'initvolume_ransac', 'initvolume_simanneal', 'convert_pdb','hg3d'],
    ['Model Refinement', 'projmatch', 'ml3d', ['relion', 'relion_classify', 'relion_refine', 'relion_postprocess'], 'projection_outliers'],
    ['Volumes', 'create_volume_mask', 'preprocess_volume', 'resolution3D', 'align_volume', 'helical_params', 'saxs']]),
('Other',
 [['Extra',
   'custom',
