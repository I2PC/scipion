...
protocols = {
        ...
        'relion_classify_continue': ('3D ClassificationCont ', '3D/RelionClassCont'),
        'relion_refine': ('Angle Refinement ', '3D/RelionRef'),
        'relion_refine_continue': ('Angle RefinementCont ', '3D/RelionRefCont'),
...
('3D',
   [['Initial Model', 'rct', 'initvolume_ransac', 'initvolume_simanneal', 'convert_pdb'],
    ['Model Refinement', 'projmatch', 'ml3d', ['relion', 'relion_classify', 'relion_classify_continue', 'relion_refine', 'relion_refine_continue']],
