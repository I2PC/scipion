...
# Particles mask RADIUS (A):
"""
The experimental images will be masked with a soft circular mask with this RADIUS. Make sure this radius is not set too small because that may mask away part of the signal! If set to a value larger than the image size no masking will be performed.
"""
MaskRadiusA = 200
