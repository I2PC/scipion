#!/usr/bin/env python
#------------------------------------------------------------------------------------------------
# Protocol for Xmipp-based mlf3d classification, according to:
# {please cite} Scheres et al. (2007) Structure, 15, 1167-1177
#
# Example use:
# ./xmipp_protocol_mlf3d.py
#
...
""" The names of the images and the ctf-parameter files should be with absolute paths.
"""
InCtfDatFile="all_images.ctfdat"
# {file} Initial 3D reference map:
InitialReference="my_ref.vol"
# Is this map CTF-amplitude corrected?
""" If coming from programs other than xmipp_mlf_refine3d this is usually not the case.
"""
InitialMapIsAmplitudeCorrected=False
# Working subdirectory:
WorkingDir="MLF3D/test1"
# Delete working subdirectory if it already exists?
DoDeleteWorkingDir=False
# {expert} Root directory name for this project:
""" Absolute path to the root directory for this project
"""
ProjectDir="/home/sjors/work/p53"
...
"""
SeedsSelfile=""
# {expert} Seeds are CTF-amplitude corrected?
""" If the seeds are generated automatically, the will be amplitude-corrected
    If you provide your own seeds, please check
"""
SeedsAreAmplitudeCorrected=True
#------------------------------------------------------------------------------------------------
# {section} MLF3D classification
#------------------------------------------------------------------------------------------------
# Perform mlf3d classification run?
DoML3DClassification=True
# Angular sampling for mlf3d classification:
""" Fine samplings take huge amounts of CPU and memory.
    Therefore, in general, dont use samplings finer than 10 degrees.
"""
AngularSampling=10
# Number of mlf3d iterations to perform:
...
""" No frequencies higher than this limit will be taken into account
    If a negative value is given, no limit is imposed
"""
HighResLimit=-1
...
"""
RestartIter=0
# {expert} Additional xmipp_mlf_refine3d parameters:
...
"""
AnalysisScript="visualize_mlf3d.py"
#------------------------------------------------------------------------------------------------
#------------------------------------------------------------------------------------------------
...
class MLF3D_class:
    ...
    def execute_MLrefine3D(self,inselfile,ctfdatfile,outname,
    ...
    def restart_MLrefine3D(self,iter):
        ...
        print '*********************************************************************'
        print '*  Restarting mlf_refine3d program :' 
        params= ' -restart RunMLF3D/ml3d_it' + str(iter).zfill(5) + '.log'
        launch_parallel_job.launch_job(self.DoParallel,
                                       "xmipp_mlf_refine3d",
                                       "xmipp_mpi_mlf_refine3d",
                                       params,
